...
// The following line of code to see the output in the browser console
...
// Refactor into an arrow function.
let objectLitNew = () => ({ key1: 'value1', key2: 'value2', key3: 'value3' });
...
// Refactor into an arrow function.
let sumAndProductNew = (a, b) => { let sum = a + b; let product = a * b; return [sum, product]; };
...
//  this refers to a student object instance of Joe
// 2. What is "this" when joe.scopeArrow() is invoked?
//  this referes to the Window properties of the browser
// 3. Explain why "this" is different when an arrow function is used.
//  because the arrow function is bubbling this to the browser Window. It is not referring it back to the student.
